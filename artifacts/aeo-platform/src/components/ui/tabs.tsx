...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-full bg-mist p-1 text-muted-foreground',
      className,
    )}
    {...props}
  />
